...
df_bg = pd.DataFrame([{'node_ids': node_id, 'timestamps': t} for node_id, times in enumerate(all_bg_spikes) for t in times])
# cell.add_random_synapses_from_df(df_bg, "AMPA_NMDA_STP", syn_params, section_pool=cell.dend)
cell.add_random_synapses_from_df(df_bg, "AMPA_NMDA_STP", syn_params, section_pool=[cell.proximal_dends,cell.distal_dends])
print(df_bg)
